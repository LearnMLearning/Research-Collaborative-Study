...
$$
\rho = \frac{\sum_{x \in \tilde D}w_x}{\sum_{x \in D} w_x}, \tilde p_k = \frac{\sum_{x\in \tilde D_k}w_k}{\sum_{x\in \tilde D}w_x}\,(1\le k \le |y|), \tilde r_v = \frac{\sum_{x \in \tilde D^v}w_x}{\sum_{x \in \tilde D}w_x}\, (1\le v \le V)
$$
