...
L(θ∣x1,…,xn)=fθ(x1,…,xn).![{\displaystyle {\mbox{L}}(\theta \mid x_{1},\dots ,x_{n})=f_{\theta }(x_{1},\dots ,x_{n}).}](https://wikimedia.org/api/rest_v1/media/math/render/svg/a9702eeec5a8eb416883af66665ac11bd8151f0f)

若D![{\displaystyle D}](https://wikimedia.org/api/rest_v1/media/math/render/svg/f34a0c600395e5d4345287e21fb26efd386990e6)是离散分布，fθ![{\displaystyle f_{\theta }}](https://wikimedia.org/api/rest_v1/media/math/render/svg/9874ae06066a2250709085e0fb521eebff2c2fb7)即是在参数为θ![{\displaystyle \theta }](https://wikimedia.org/api/rest_v1/media/math/render/svg/6e5ab2664b422d53eb0c7df3b87e1360d75ad9af)时观测到这一采样的概率；若其是连续分布，fθ![{\displaystyle f_{\theta }}](https://wikimedia.org/api/rest_v1/media/math/render/svg/9874ae06066a2250709085e0fb521eebff2c2fb7)则为X1,X2,…,Xn![{\displaystyle X_{1},X_{2},\ldots ,X_{n}}](https://wikimedia.org/api/rest_v1/media/math/render/svg/d67872301909a9d739e265252ad0c7339cead069)联合分布的概率密度函数在观测值处的取值。一旦我们获得X1,X2,…,Xn![{\displaystyle X_{1},X_{2},\ldots ,X_{n}}](https://wikimedia.org/api/rest_v1/media/math/render/svg/d67872301909a9d739e265252ad0c7339cead069)，我们就能求得一个关于θ![{\displaystyle \theta }](https://wikimedia.org/api/rest_v1/media/math/render/svg/6e5ab2664b422d53eb0c7df3b87e1360d75ad9af)的估计。最大似然估计会寻找关于θ![{\displaystyle \theta }](https://wikimedia.org/api/rest_v1/media/math/render/svg/6e5ab2664b422d53eb0c7df3b87e1360d75ad9af)的最可能的值（即，在所有可能的θ![{\displaystyle \theta }](https://wikimedia.org/api/rest_v1/media/math/render/svg/6e5ab2664b422d53eb0c7df3b87e1360d75ad9af)取值中，寻找一个值使这个采样的“可能性”最大化）。从数学上来说，我们可以在θ![{\displaystyle \theta }](https://wikimedia.org/api/rest_v1/media/math/render/svg/6e5ab2664b422d53eb0c7df3b87e1360d75ad9af)的所有可能取值中寻找一个值使得似然[函数](https://zh.wikipedia.org/wiki/%E5%87%BD%E6%95%B0 "函数")取到最大值。这个使可能性最大的θ^![{\displaystyle {\widehat {\theta }}}](https://wikimedia.org/api/rest_v1/media/math/render/svg/89a031ed08d81ed4f0df984f0d9f30b7ae07be46)值即称为θ![{\displaystyle \theta }](https://wikimedia.org/api/rest_v1/media/math/render/svg/6e5ab2664b422d53eb0c7df3b87e1360d75ad9af)的**最大似然估计**。由定义，最大似然估计是样本的函数。